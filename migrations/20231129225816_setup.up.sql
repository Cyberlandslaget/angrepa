...
CREATE TRIGGER execution_notify AFTER INSERT OR UPDATE OR DELETE ON execution
FOR EACH ROW EXECUTE PROCEDURE notify_trigger();

CREATE TRIGGER flag_notify AFTER INSERT OR UPDATE OR DELETE ON flag
FOR EACH ROW EXECUTE PROCEDURE notify_trigger();

CREATE TRIGGER exploit_notify AFTER INSERT OR UPDATE OR DELETE ON exploit
FOR EACH ROW EXECUTE PROCEDURE notify_trigger();